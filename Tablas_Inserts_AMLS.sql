...
CREATE TABLE PROYECTO_pedido(
    ...
    CONSTRAINT fk_dir_pedido FOREIGN KEY (numero_direc) REFERENCES PROYECTO_direccion 
);
...
CREATE TABLE PROYECTO_factura(
    ...
    CONSTRAINT fk_dir_factura FOREIGN KEY (numero_direc) REFERENCES PROYECTO_direccion,
...
(1, 2, 1, 1, to_date('21-01-2022','dd-mm-yyyy'), to_date('11-11-2022','dd-mm-yyyy'), 'Funko Luffy One Piece ', './ImagenesProyecto/ProductoLuffy.png' ,14.95, 21, 'De la famosa serie One Piece');
INSERT INTO PROYECTO_productos(codigo, categoria, usuario_crea, usuario_modifica, f_creac, f_ult_modificacion, nombre,imagen, precio, IVA,  descrip_caract) VALUES 
(2, 1, 1, 1, to_date('02-06-2022','dd-mm-yyyy'), to_date('08-01-2023','dd-mm-yyyy'), 'Funko Spider-Man', './ImagenesProyecto/ProductoSpiderman.png' , 14.95, 21, 'De comics y películas Marvel');
INSERT INTO PROYECTO_productos(codigo, categoria, usuario_crea, usuario_modifica, f_creac, f_ult_modificacion, nombre,imagen, precio, IVA,   descrip_caract) VALUES 
(3, 3, 1, 1, to_date('16-01-2022','dd-mm-yyyy'), to_date('10-02-2023','dd-mm-yyyy'), 'Funko Harry Potter ', './ImagenesProyecto/ProductoHarry.png' , 19.95, 21, 'De la saga de libros de Harry Potter');
INSERT INTO PROYECTO_productos(codigo, categoria, usuario_crea, usuario_modifica, f_creac, f_ult_modificacion, nombre,imagen, precio, IVA,  descrip_caract) VALUES
(4, 1, 1, 1, to_date('22-02-2023','dd-mm-yyyy'), to_date('22-01-2023','dd-mm-yyyy'), 'Funko Black Panter', './ImagenesProyecto/ProductoPanter.png' , 14.95, 21, 'El comandate de los Avengers ha llegado');
INSERT INTO PROYECTO_productos(codigo, categoria, usuario_crea, usuario_modifica, f_creac, f_ult_modificacion, nombre,imagen, precio, IVA,  descrip_caract) VALUES
(5, 4, 1, 1, to_date('22-02-2023','dd-mm-yyyy'), to_date('22-01-2023','dd-mm-yyyy'), 'Funko Michael Jordan', './ImagenesProyecto/ProductoJordan.png' , 19.95, 21, 'El histórico 23 de los Bulls viene haciendo mates');
INSERT INTO PROYECTO_productos(codigo, categoria, usuario_crea, usuario_modifica, f_creac, f_ult_modificacion, nombre,imagen, precio, IVA,  descrip_caract) VALUES
...
INSERT INTO PROYECTO_pedido(codigo, usuario, numero_direc, fecha,  tipo_pago) VALUES
(2, 3, 2 , to_date('05-08-2022','dd-mm-yyyy') ,  'PAYPAL');
